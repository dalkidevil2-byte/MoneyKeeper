...
- "총합계" (할인 전) X. 예: 총합계 23,710 / 결제금액 14,850 → total = 14850

[items.amount]
- "금액" 컬럼/줄 끝의 큰 숫자
- 단가/수량 X
- 증정품(0원/증정 표시) 은 amount=0 또는 생략

[검증]
- items 합이 total 보다 클 수 있음 (할인 차이) — OK
- items 합이 total 보다 너무 작으면 (수량을 amount 로 오인) 재매칭
