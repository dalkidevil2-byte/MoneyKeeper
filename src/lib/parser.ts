...
const MERCHANT_CATEGORY_MAP: Array<{
  ...
  { keywords: ['스타벅스', '커피빈', '투썸플레이스', '투썸', '이디야', '폴바셋', '블루보틀', '빽다방', '메가커피', '컴포즈', '카페', '커피', '아메리카노', '라떼', '카푸치노', '마끼아또'], main: '식비', sub: '카페' },
  ...
  { keywords: ['쿠팡', '네이버쇼핑', '11번가', 'G마켓', '옥션', '위메프', '티몬', '인터파크'], main: '생활', sub: '생필품' },
  { keywords: ['다이소'], main: '생활', sub: '생필품' },
  { keywords: ['넷플릭스', '유튜브', '왓챠', '티빙', '웨이브', '스포티파이', '애플뮤직'], main: '고정비', sub: '구독료' },
  { keywords: ['통신비', 'SKT', 'KT', 'LGU+', '알뜰폰'], main: '고정비', sub: '통신' },
  { keywords: ['보험', '삼성생명', '한화생명', '교보생명', '실비'], main: '고정비', sub: '보험' },
  { keywords: ['월급', '급여'], main: '수입', sub: '급여' },
  { keywords: ['출장비', '출장수당', '출장비지급', '출장비수령'], main: '수입', sub: '기타' },
  { keywords: ['출장'], main: '출장', sub: '기타' },
  { keywords: ['정육', '축산', '한우', '정육점'], main: '식비', sub: '육고기' },
  { keywords: ['수산', '어시장', '횟집'], main: '식비', sub: '해산물' },
  { keywords: ['주류', '와인', '이자카야', '호프', '포차'], main: '식비', sub: '술' },
];
