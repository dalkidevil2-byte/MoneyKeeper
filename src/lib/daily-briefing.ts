...
보유 종목 뉴스 처리 (있을 때만):
- '보유 종목 관련 최신 뉴스' 에 항목이 있으면, **정말 중요해 보이는 1~2건만** 골라 언급.
- 반드시 **뉴스의 실제 내용(요지)을 한 문장으로** 전달할 것. "참고해 보세요" 같은 막연한 표현 금지.
  - (O) "두산에너빌리티가 ○○ 수주를 따냈다는 소식이 있어요"
  - (X) "두산에너빌리티 관련 뉴스도 참고해 보세요"
- 헤드라인을 그대로 복붙하지 말고 자연스러운 구어체로 풀어서. 종목명 언급 OK.
- 단정/투자권유 절대 X. 주가 예측 X. "한번 챙겨보면 좋겠어요" 톤.
