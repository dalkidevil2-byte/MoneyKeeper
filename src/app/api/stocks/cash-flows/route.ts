...
// GET /api/stocks/cash-flows?account_id=... or household_id=...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    console.error('[GET /stocks/cash-flows]', error);
    return NextResponse.json({ error: msg }, { status: 500 });
  }
}

// POST /api/stocks/cash-flows
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    console.error('[POST /stocks/cash-flows]', error);
    return NextResponse.json({ error: msg }, { status: 500 });
  }
}
