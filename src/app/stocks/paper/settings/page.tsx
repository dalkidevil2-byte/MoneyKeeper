...
import { ChevronLeft, Plus, Pencil, Wallet, FlaskConical } from 'lucide-react';
...
const API_BASE = '/api/stocks/paper';
...
export default function PaperSettingsPage() {
  ...
  const [ownerSheet, setOwnerSheet] = useState<
    { mode: 'create' } | { mode: 'edit'; owner: Owner } | null
  >(null);
    ...
    <div className="min-h-screen bg-gray-50 pb-24">
      <div className="sticky top-0 z-10 bg-white border-b border-gray-100">
        <div className="max-w-lg mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <h1 className="text-lg font-bold text-gray-900 flex-1">모의 소유자 · 계좌</h1>
        </div>
      </div>
          ...
          <>
            <section>
              ...
              {owners.length === 0 ? (
                <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 text-center">
                  <p className="text-sm text-gray-500">등록된 모의 소유자가 없습니다</p>
                  <button
                    onClick={() => setOwnerSheet({ mode: 'create' })}
            ...
            <section>
              ...
              {owners.length === 0 ? (
                ...
                <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 text-center">
                  <p className="text-sm text-gray-500">등록된 모의 계좌가 없습니다</p>
                  <button
                    onClick={() => setAccountSheet({ mode: 'create' })}
                    className="mt-3 px-4 py-2 rounded-xl bg-violet-600 text-white text-xs font-semibold"
                  >
                          ...
                          {accs.map((a) => (
                            <li key={a.id} className="flex items-center px-5 py-3 active:bg-gray-50">
                              ...
                              <button
                                ...
                                className="ml-3 p-2 rounded-lg bg-violet-50 text-violet-600 active:bg-violet-100"
                                title="시드머니"
                              >
                                <Wallet size={16} />
                              </button>
